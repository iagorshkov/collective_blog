...
Описание проекта: В сервисе есть несколько блогов, в которые пишут пользователи. На главной странице находится лента всех записей всех блогов. Можно просматривать записи одного блога. Записи можно комментировать. Комментарии расположены лесенкой. Пользователи и посты имеют систему рейтингов: пользователь может голосовать за пост или пользователя положительно или отрицательно. Если рейтинг поста ниже определенного уровня - пост не показывается, если рейтинг пользователя ниже определенного уровня, пользователю запрещено писать посты.
...
3 - Присутствует возможность отобразить посты с самым высоким рейтингом 4
